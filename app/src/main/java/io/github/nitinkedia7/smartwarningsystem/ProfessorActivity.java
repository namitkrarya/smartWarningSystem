                    ...
                    mSessionDatabaseReference.child(mSessionName).addListenerForSingleValueEvent( new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if (Boolean.valueOf(dataSnapshot.child("isActive").getValue().toString())) {
                                ...
                                Boolean isStudentJoined = Boolean.valueOf(dataSnapshot.child("isUserJoined").getValue().toString());
                                if (isStudentJoined) disengageStudents((Map<String, Object>) dataSnapshot.child("joinedUsers").getValue());
